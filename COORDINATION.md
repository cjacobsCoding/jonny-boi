...
- 2026-08-23 DESKTOP-90PJPM4: `fix/pilot-blink-weak-rows` 🚧 PUSHED — DESIGN §3.43. Off `main`.
  **5218 / 0**, `verify` 0. packages/ai ONLY.
  ...
  Also rejected, with numbers in §3.43: pricing prevented damage as a block BONUS (1343–1484). Shipped
