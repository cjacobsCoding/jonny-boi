...
| fix/play-imported-decks | DESKTOP-90PJPM4 (integrator) | apps/web/src/lib/play/setup.ts, apps/web/src/components/online/OnlinePlay.tsx, NEW apps/web/src/lib/play/imported-deck-playable.test.ts, DESIGN §3.48, COORDINATION | 🚧 PUSHED, not merged |
...
- 2026-08-24 DESKTOP-90PJPM4: `fix/play-imported-decks` 🚧 PUSHED — DESIGN §3.48. **A saved deck
