...
| feat/play-vs-ai | DESKTOP-90PJPM4 (worker) | apps/web ONLY (lib/play/seat.ts +solo transport, NEW lib/play/ai-seat.ts + test, lib/play/play-config.ts +2 knobs, views/PlayView.tsx, components/play/SetupScreen.tsx, components/lab/PilotControls.tsx label prop, styles.css +1 rule), DESIGN §3.43, COORDINATION | 🚧 PUSHED, not merged |
...
- 2026-08-23 DESKTOP-90PJPM4: `feat/play-vs-ai` 🚧 PUSHED — DESIGN §3.43. Off `main`. **5208 / 0**,
