...
import { isCreature } from '@jonny-boi/core';

/** What kind of thing a target must be. */
export type TargetKind = 'creature' | 'player' | 'any' | 'spell';
