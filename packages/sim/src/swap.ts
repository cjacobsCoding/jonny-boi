 ...
 * remain unimplemented (transform/DFC, dynamic P/T, planeswalker loyalty, flashback
 * granted by another card — see `FIDELITY_CAVEAT`), so cards using them play as a
