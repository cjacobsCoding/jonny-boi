...
Nine times now on this surface, work has been **built, tested, green, and unreachable by a player** — and the card campaign manufactures a tenth by design, which is why §5a makes the pool regeneration a scheduled step rather than a side effect.
