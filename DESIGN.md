...
- ✅ **§3.22 — *the fifth mana shape: a SPEND RESTRICTION on produced mana*.** The other four shapes
...
- *the two colour-derivation families this engine has no object for*, now reported separately
  ...
  Signet) needs a format this engine does not implement and will not fake — see §3.22 — while
